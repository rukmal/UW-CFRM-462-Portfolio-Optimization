...
# CFRM 462 - Introduction to Computational Finance and Financial Econometrics
...
```{r child = "chapters/TitlePage.tex"}
```
\newpage
...
```{r child = "chapters/ExecutiveSummary.Rmd"}
```
...
```{r child = "chapters/chapter1_Introduction.Rmd", include = FALSE}
```
\newpage
